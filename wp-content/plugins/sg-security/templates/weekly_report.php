    ...
    <tr>
        <td>
            ...
            <table class="flex" align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <?php
                    include_once( \SG_Security\DIR . preg_replace( '~{LANG}~', $args['locale'], '/templates/partials/weekly-report/intro/{LANG}.php' ) );
                ?>
                <tr>
                    <td class="body-text"
                ...
                <?php
                    include_once( \SG_Security\DIR . preg_replace( '~{LANG}~', $args['locale'], '/templates/partials/weekly-report/learn-more/{LANG}.php' ) );
                ?>
                <?php if (
